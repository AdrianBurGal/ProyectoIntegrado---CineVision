      ...
      <div id="contTableAdmin">
        ...
        <form [formGroup]="filmForm" (ngSubmit)="createFilm()">
          ...
          <div class="form-group">
            ...
            <input type="number" id="duration" name="duration" formControlName="duration" step="1" min="0">
          ...
          <div class="form-group">
            ...
            <div *ngIf="submitted && form['photoUrl'].errors?.['pattern']"
                 class="error-message">Invalid URL format (name + .jpg / .gif / .png / .webp)
            </div>
          </div>
          <div class="form-group">
            <label for="trailer">Trailer:</label>
            <input type="url" id="trailer" name="trailer" formControlName="trailer">
          </div>
...
export class CreateFilmComponent {
  ...
  constructor(private formBuilder: FormBuilder, private router: Router) {
    this.filmForm = this.formBuilder.group({
      ...
      photoUrl: ['', [Validators.required, Validators.pattern('([.|\\w|\\s|-])*\\.(?:jpg|gif|png|webp)')]],
      trailer: [''],
    });
  }
